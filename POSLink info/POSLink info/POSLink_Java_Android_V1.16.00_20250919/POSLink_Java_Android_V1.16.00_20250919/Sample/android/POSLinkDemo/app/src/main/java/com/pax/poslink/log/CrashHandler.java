...
public class CrashHandler implements Thread.UncaughtExceptionHandler {
    ...
    /**
     *  Reset HomeKey and RecentKey when app crash
     * @param throwable
     * @return
     */
    private boolean resetButton(final Throwable throwable) {
        if (throwable == null) {
            return false;
        }
        MiscSettings.setHomeKeyEnable(mContext, true);
        MiscSettings.setRecentKeyEnable(mContext, true);
        MiscSettings.setNavigationBarVisible(mContext, true);
        MiscSettings.setNavigationBarEnable(mContext, true);
        return true;
    }
}
