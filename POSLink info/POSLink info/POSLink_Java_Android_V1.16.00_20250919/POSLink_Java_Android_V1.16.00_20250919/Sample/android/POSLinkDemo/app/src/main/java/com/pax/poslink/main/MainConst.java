...
public class MainConst {
    ...
    public static final List<String> EDC_TYPES = Arrays.asList("ALL", "CREDIT", "DEBIT", "CHECK", "EBT", "GIFT", "LOYALTY", "CASH", "");
    public static final List<String> TRANS_TYPE = Arrays.asList(
            "UNKNOWN", "AUTH", "SALE", "RETURN", "VOID", "POSTAUTH",
            "FORCEAUTH", "ADJUST", "INQUIRY", "ACTIVATE", "DEACTIVATE", "RELOAD", "VOID SALE",
            ...
            "BALANCEWITHLOCK", "REDEMPTIONWITHUNLOCK", "REWARDS", "REENTER", "TRANSACTION ADJUSTMENT", "TRANSFER", "FINALIZE", "DEPOSIT", "ACCOUNT PAYMENT",
            "FORCED PREAUTH", "VOID FORCED PREAUTH", "IDENTIFY"
    );
    public static final List<String> PAYMENT_EDC_TYPES = Arrays.asList("CREDIT", "DEBIT", "CHECK", "EBT_FOODSTAMP", "EBT_CASHBENEFIT", "GIFT", "LOYALTY", "CASH", "EBT", "CHECKCARDTYPE", "QRPAYMENT", "PREINPUTACCOUNT");
    public static final List<String> CARD_TYPES = Arrays.asList(
            "UNKNOWN", "VISA", "MASTERCARD", "AMEX",
            "DISCOVER", "DINERCLUB", "ENROUTE", "JCB",
            "REVOLUTIONCARD", "INTERAC ", "CUP",
            "MAESTRO", "SINCLAIR", "OTHER"
    );
    ...
    public static final String[] slBatchTrans =
            {"BATCHCLOSE", "FORCEBATCHCLOSE", "BATCHCLEAR", "PURGEBATCH", "SAFUPLOAD",
                    "DELETESAFFILE", "DELETETRANSACTION"};
    public static final String[] slReportTrans =
            {"LOCALTOTALREPORT", "LOCALDETAILREPORT", "LOCALFAILEDREPORT",
                    "HOSTREPORT", "HISTORYREPORT", "SAFSUMMARYREPORT", "HOSTDETAILREPORT"};
    public static final String[] slTrans =
            {"UNKNOWN", "AUTH", "SALE", "RETURN", "VOID", "POSTAUTH",
    ...
    public static final String[] slTrend =
            {"ALL", "CREDIT", "DEBIT", "CHECK", "EBT_FOODSTAMP", "EBT_CASHBENEFIT",
                    "GIFT", "LOYALTY", "CASH", "EBT", "CHECKCARDTYPE", "DOQRPAYMENT", "PREINPUTACCOUNT"};
    public static final String[] slCardType =
            {"UNKNOWN", "VISA", "MASTERCARD", "AMEX", "DISCOVER", "DINERCLUB", "ENROUTE", "JCB",
                    "REVOLUTIONCARD", "VISAFLEET", "MASTERCARDFLEET", "FLEETONE",
                    "FLEETWIDE", "FUELMAN", "GASCARD", "VOYAGER", "WRIGHTEXPRESS", "INTERAC ", "CUP",
                    "MAESTRO", "SINCLAIR", "OTHER"};
}
